        ...
        if (this.getColor().equals(Piece.WHITE)) {
            if (oldRow == 6) {   
                ...
                if (Math.abs(newCol - oldCol) == 1 && newRow == oldRow - 1 && b.hasPiece(newRow, newCol)) {
                  ...
                  }else if (newCol == oldCol - 1 && newRow == oldRow - 1  && b.hasPiecePawnBlack(newRow + 1, newCol ) ) {
            ...
            if (oldRow == 1) {   
               ...
               if (Math.abs(newCol - oldCol) == 1 && newRow == oldRow + 1 && b.hasPiece(newRow, newCol)) {
                    ...
                    return true;
                } else if (newCol == oldCol - 1 && newRow == oldRow + 1  && b.hasPiecePawnWhite(newRow - 1, newCol )) {
                    return true;
                }else if (newCol == oldCol + 1 && newRow == oldRow + 1  && b.hasPiecePawnWhite(newRow - 1, newCol )) {
                    return true;
                }
