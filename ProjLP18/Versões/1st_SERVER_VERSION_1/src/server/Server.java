            ...
            try {
                if ((playerName = reader.readLine()) != null) {
                    ...
                    if (playerNames.size() == 2) {
                        ...
                        updateLog("Jogador " + playerNames.get(0) + " conectou-se!");
                        updateLog("Jogador " + playerNames.get(1) + " conectou-se!");
                        sendPlayerInfo();
                        startDataThread();
                    }
                }
            ...
            try {
                while ((message = reader.readLine()) != null) {
                    if (message.contains("_")) {
                        ...
                        String data = "Jogador " + name + " moveu uma peça...";
                        updateLog(data);
                        sendMoveInfo(message);
                    } else {
                        String data = "Mensagem recebida do Jogador...";
                        updateLog(data);
